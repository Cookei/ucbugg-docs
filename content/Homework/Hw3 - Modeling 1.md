...
> [!todo] Todo: Maya File
> - The `.ma` file of the completed assignment renamed as `section_hw1_firstname_lastname.ma`

## Rubric

| Item                                     | Points |
| ---------------------------------------- | ------ |
| Turned in something                      | 4      |
| Fully completed assignment               | 2      |
| Deleting history                         | 1      |
...
> Create a comprehensive asset list and assign each group member to model a few assets.  
>
> > [!info] Reminder
