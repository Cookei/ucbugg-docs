...
Enrollment is handled based on the submission of an application consisting of a short assignment alongside a form. The details of this application will be announced at the UCBUGG DeCal infosessions

Details about the infosession including when and where they are located will be announced on our [3DMA Discord Server](https://discord.gg/WftbZAB72b). Please join the Discord server to see any and all announcements regarding enrollment

It is **mandatory** to attend the infosession to be considered for enrollment into the class. This infosession usually occurs the second week of the semester

Students **must** be fully enrolled in both this class and at UC Berkeley. Enrollment codes and instructions will be given once accepted into the DeCal

# Prerequisites

There are no prerequisites for this class. We do not expect anyone to have any background in either art or tech to take this class

It is required that students have access to a personal computer that can run the current version of Autodesk Maya that is in use for the class. As of Fall 2026, we no longer have access to a computer lab. If you do not have a personal computer, you can request one from the [Student Technology Equity Services ](https://studenttech.berkeley.edu/step) program

# Communication

All course schedule and communications will be on Discord. A Discord server will be created and you will be invited to it once you get accepted in the class. If you need to contact the course staff privately, you can email ucbugg@gmail.com or message a facilitator directly.

> [!attention]
> All homework related questions must be handled in the appropriate channels in the course Discord server. Do not direct message facilitators for help on homework. Direct messaging facilitators is reserved for personal concerns related to the course
...
We will have two 2 hour office hours held in-person and online throughout the semester. More details on the location of office hours will be released at a later date.

The office hour schedule will also be publicly posted, however, note that the schedule might change week to week

# Readings

We do not have any mandatory readings. However, at the end of each lecture topic, we will provide additional optional reading if you are interested in pursuing the subject further

# Assignments

## Homework

There will be a homework assignment assigned every week relating to the concept taught during lecture. It is expected that you complete the assignment in a timely fashion as the following group work heavily depends on the collaboration and knowledge gained from the homework.

Homework rubrics are listed on each relevant homework assignment. Homework is **not** graded on quality but on completion and correctness of the required materials.
...
> [!danger]
> It is incredibly important that you stay on track with your group work. A lot of the 3D pipeline relies on top of each other, and failure to complete certain steps delays the entire pipeline. Do not underestimate the amount of work required

### Weekly Group Progress

As a part of your group work, you will be required to submit a weekly slide deck consisting of your progress for the week alongside a small writeup detailing what you worked on. These slides will be reviewed in class by the facilitator assigned to your group.

For examples on past student slide decks, you can refer to them [here](https://docs.google.com/presentation/d/1ugrxMGtllFh9va9S3aX14AWUwgmkOgagvSUbxP5QvGE/edit?usp=sharing).
...
There will also still be lecture after the in-class midterm critique.
...
This is a P/NP course. A grade of 70% or higher will result in a Pass.

## Attendance Policy

There will be an excused absence form for lecture attendance. A maximum of 2 excused absences & 1 unexcused absence will be given. Each additional absence after that will be a 5% deduction on the final grade

## Homework Policy

For all individual homework assignments, there will be an extension request form. Up to a 1 week extension on the assignment will be given, no questions asked. Any extensions beyond that are handled on a case-by-case basis. Additionally, your lowest homework score will also be dropped.
...
It is highly encouraged to collaborate with your peers on homework and group work. We believe that the best way to learn is to communicate and share with others. That said, it is not okay to have someone do the assignment for you. Unless it is for specific debugging purposes, you nor others should not go on another person's computer to complete complex steps for them unless specifically for debugging purposes.

We believe that students will be able to distinguish between what is collaboration and teaching, and what constitutes as cheating.

# Student Support

## Extenuating Circumstances and Inclusion

If the above extension policy is not sufficient due to unexpected personal circumstances, please contact a head facilitator and we will be able to resolve them for you. At the end of the day, this is a DeCal and you are meant to have fun. If extenuating circumstances come in the way of that, please let us know and we will work with you.
...
- If something is said in class (by anyone) that makes you feel uncomfortable, disrespected, or excluded by a staff member or fellow student, please report the incident so that we can work to address the issue and create a more supportive and inclusive learning environment. Some options are:
	- The anonymous feedback from (listed on our course Discord)
    - A departmental [Faculty Equity Advisor](https://diversity.berkeley.edu/faculty-equity-advisors), the [UC Berkeley Campus Ombuds Office](https://sa.berkeley.edu/ombuds) or the ASUC [Student Advocate’s Office (SAO)](https://advocate.berkeley.edu/)
    - The [anonymous feedback form](https://engineering.berkeley.edu/about/equity-and-inclusion/feedback/) for the College of Engineering for equity and inclusion related feedback. Our DeCal is listed under the EECS Department
...
- Pronouns can be different for each student and should not be assumed. If you are misgendered by staff or another student, please respond however is best for you in the moment. If you're open to letting us know about the incident via [email](ucbugg@gmail.com) or through the department's [Student Climate and Incident Reporting Form](https://docs.google.com/forms/d/e/1FAIpQLSc4NYHdUJ8IzYA1SoiTinWBybGWkj0mfmdnHAeygAxkZajelQ/viewform), we would really appreciate it, so we can both make sure you are appropriately addressed and continue to build habits of inclusion in our staff. You can also direct message a head facilitator directly if you do not wish to go through official department contacts.
...
We committed to creating a learning environment that meets the needs of its diverse student body including students with disabilities. If you anticipate or experience any barriers to learning in this course, please feel welcome to discuss your concerns with the head facilitators.
...
Parts of the student support policy has been adapted from CS168.
